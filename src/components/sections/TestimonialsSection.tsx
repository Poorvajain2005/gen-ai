...
export function TestimonialsSection() {
  ...
  return (
    <section className="relative py-12 bg-gradient-to-br from-slate-800 via-emerald-900 to-green-900 overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-emerald-500/10 via-transparent to-green-500/10" />
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-emerald-500/5 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-green-500/5 rounded-full blur-3xl animate-pulse" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Loved by
            <span className="bg-gradient-to-r from-emerald-400 to-green-400 bg-clip-text text-transparent"> 1,500+ brands</span>
          </h2>
                  ...
                  <EnhancedHoverCard>
                    ...
                    <EnhancedHoverCardContent className="w-80">
                      <div className="space-y-3">
                        ...
                        <div className="pt-2">
                          <button className="w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white px-4 py-2 rounded-lg text-sm font-medium">
                            Play Video
                          </button>
                        </div>
                      </div>
