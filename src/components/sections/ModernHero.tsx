...
const testimonials = [
  {
    ...
    content: "Gen Goodwill.ai transformed our influencer marketing. 3x ROI increase in just 6 months!",
  ...
  },
  {
    ...
    role: "Growth Manager", 
    company: "TechFlow",
    content: "The AI-powered matching is incredible. We found perfect influencers in minutes, not days.",
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2 pt-2">
                    <div className="flex -space-x-2">
                      {[1, 2, 3, 4].map((i) => (
                        <div key={i} className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full border-2 border-white" />
                      ))}
                    </div>
                    <span className="text-xs text-gray-500">+1,497 more</span>
                  </div>
                </div>
          ...
          <div className="relative lg:min-h-[600px] flex items-center justify-center">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    {testimonials.map((testimonial, index) => (
                      <div key={index} className="flex items-center space-x-4 p-4 rounded-2xl hover:bg-gray-50 transition-all duration-300 border border-gray-100 hover:border-gray-200">
                        <img 
            ...
            {/* Floating Elements - positioned to avoid overlap */}
            <div className="absolute -top-8 -right-8 bg-gradient-to-r from-blue-600 to-purple-600 text-white p-4 rounded-full shadow-2xl animate-bounce z-20 hidden lg:block transform hover:scale-110 transition-transform duration-300">
              <Star className="h-7 w-7" />
            </div>
            <div className="absolute -bottom-8 -left-8 bg-gradient-to-r from-purple-600 to-pink-600 text-white p-4 rounded-full shadow-2xl animate-pulse z-20 hidden lg:block transform hover:scale-110 transition-transform duration-300">
              <Play className="h-7 w-7" />
            </div>
            
            {/* Additional floating cards - repositioned */}
            <div className="absolute -top-16 left-8 bg-white/95 backdrop-blur-md rounded-2xl shadow-xl p-5 border border-gray-200/50 animate-float z-30 hidden lg:block transform hover:scale-105 transition-transform duration-300">
              <div className="flex items-center space-x-3">
                <div className="w-4 h-4 bg-green-500 rounded-full animate-pulse shadow-sm"></div>
                <div>
                  <div className="text-sm font-semibold text-gray-800">Live Campaign</div>
                  <div className="text-xs text-gray-500">Active now</div>
                </div>
              </div>
            </div>
            
            <div className="absolute -bottom-16 right-8 bg-white/95 backdrop-blur-md rounded-2xl shadow-xl p-5 border border-gray-200/50 animate-float-delayed z-30 hidden lg:block transform hover:scale-105 transition-transform duration-300">
              <div className="flex items-center space-x-3">
                <TrendingUp className="h-5 w-5 text-blue-600" />
                <div>
                  <div className="text-sm font-semibold text-gray-800">+127% Growth</div>
