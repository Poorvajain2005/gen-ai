...
const Ecommerce = () => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-emerald-50 via-slate-50 to-green-50 py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {successMetrics.map((metric, index) => (
            <div key={index} className="bg-white p-6 rounded-xl shadow-lg text-center">
              <h3 className="text-3xl font-bold text-emerald-600 mb-2">{metric.value}</h3>
