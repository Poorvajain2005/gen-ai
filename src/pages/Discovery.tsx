  ...
  const features = [
    {
      ...
      description:
        "Our advanced AI analyzes 50+ data points including audience demographics, engagement rates, content quality, and brand alignment to find your perfect influencer matches.",
      icon: "🤖",
      details: [
    ...
    },
    {
      ...
      description:
        "Access the largest verified influencer database with detailed profiles, audience insights, and performance metrics across Instagram, TikTok, YouTube, Twitter, and LinkedIn.",
      icon: "📊",
      details: [
    ...
    },
    {
      ...
      description:
        "Find influencers using 100+ search criteria including demographics, interests, location, engagement rates, audience quality, and brand safety metrics.",
      icon: "🔍",
      details: [
    ...
    },
    {
      ...
      description:
        "Deep audience analysis including demographics, interests, purchasing behavior, and brand affinity to ensure perfect brand-influencer-audience alignment.",
      icon: "👥",
      details: [
        "Detailed audience demographics and psychographics",
    ...
    },
    {
      ...
      description:
        "Monitor competitor influencer partnerships, campaign strategies, and performance metrics to identify opportunities and stay ahead of market trends.",
      icon: "⚡",
      details: [
    ...
    },
    {
      ...
      description:
        "Continuous monitoring and verification of influencer authenticity, audience quality, and engagement rates to ensure campaign success and fraud prevention.",
      icon: "✅",
      details: [
  ...
  const influencerCategories = [
    {
      ...
      range: "1M+ followers",
      description:
        "Celebrity influencers and major creators with massive reach",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-slate-100">
      ...
      <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <section className="text-center max-w-4xl mx-auto pt-16">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">
            AI-Powered Influencer Discovery
          </h1>
          <p className="text-xl text-gray-600 mb-12">
            Find the perfect influencers for your brand with our advanced AI
            technology. Access 10M+ verified profiles with detailed analytics,
            audience insights, and fraud detection.
          </p>
        </section>
