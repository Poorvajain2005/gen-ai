      ...
      <div className="max-w-7xl mx-auto">
        ...
        <section className="text-center mb-16">
          ...
          <div className="flex justify-center gap-4">
            <Link to="/webinars/register" className="bg-green-600 text-white px-8 py-3 rounded-lg hover:bg-green-700 transition">
              Browse All Webinars
            </Link>
            <Link to="/certification" className="border border-green-600 text-green-600 px-8 py-3 rounded-lg hover:bg-green-50 transition">
              Get Certified
            </Link>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg text-center">
            <div className="text-3xl font-bold text-gray-600 mb-2">15K+</div>
        ...
        <section className="bg-gray-700 rounded-2xl p-8 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/webinars/register" className="bg-white text-green-600 px-8 py-3 rounded-lg hover:bg-gray-100 transition font-semibold">
                Browse All Webinars
              </Link>
              <Link to="/certification" className="border border-white text-white px-8 py-3 rounded-lg hover:bg-white hover:text-green-600 transition">
                Start Certification
              </Link>
            </div>
          </div>
